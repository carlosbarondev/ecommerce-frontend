...
export const Footer = () => {
    ...
    return (
        <footer className="row row-cols-4 py-5 mt-auto border-top d-flex justify-content-around align-items-center" style={{ "backgroundColor": "#f8f9fa", "overflow": "hidden", "padding": "0", "margin": "0" }}>
